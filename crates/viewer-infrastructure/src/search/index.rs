...
use viewer_application::{
    ...
    metadata::{
        FileCopyProjection, FileMoveProjection, IndexProgress, IndexedNode, Marker, MarkerChange,
        MarkerProjectionError, MarkerProjectionPort, OperationProjectionError,
