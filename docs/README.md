...
This index distinguishes current sources of truth from superseded decisions and
point-in-time implementation evidence. Document status does not imply product
completion.
...
| [`superpowers/plans/2026-07-16-viewer-foundation-hardening-plan.md`](superpowers/plans/2026-07-16-viewer-foundation-hardening-plan.md) | Historical | — |
| [`superpowers/plans/2026-07-16-viewer-foundation-plan.md`](superpowers/plans/2026-07-16-viewer-foundation-plan.md) | Historical | — |
| [`superpowers/plans/2026-07-16-viewer-g1-image-pipeline-plan.md`](superpowers/plans/2026-07-16-viewer-g1-image-pipeline-plan.md) | Historical | — |
| [`superpowers/plans/2026-07-16-viewer-g2-file-transactions-plan.md`](superpowers/plans/2026-07-16-viewer-g2-file-transactions-plan.md) | Historical | — |
| [`superpowers/plans/2026-07-16-viewer-g3-scan-search-plan.md`](superpowers/plans/2026-07-16-viewer-g3-scan-search-plan.md) | Historical | — |
| [`superpowers/plans/2026-07-16-viewer-g4-architecture-freeze-plan.md`](superpowers/plans/2026-07-16-viewer-g4-architecture-freeze-plan.md) | Historical | — |
| [`superpowers/plans/2026-07-16-viewer-m1-browsing-core-plan.md`](superpowers/plans/2026-07-16-viewer-m1-browsing-core-plan.md) | Historical | — |
| [`superpowers/plans/2026-07-16-viewer-m2-review-efficiency-plan.md`](superpowers/plans/2026-07-16-viewer-m2-review-efficiency-plan.md) | Historical | — |
| [`superpowers/plans/2026-07-16-viewer-m3-organization-comparison-plan.md`](superpowers/plans/2026-07-16-viewer-m3-organization-comparison-plan.md) | Historical | — |
| [`superpowers/plans/2026-07-20-viewer-internal-pointer-drag-plan.md`](superpowers/plans/2026-07-20-viewer-internal-pointer-drag-plan.md) | Historical | — |
| [`superpowers/plans/2026-07-20-viewer-m3-drag-session-rearchitecture-plan.md`](superpowers/plans/2026-07-20-viewer-m3-drag-session-rearchitecture-plan.md) | Historical | — |
| [`superpowers/plans/2026-07-20-viewer-marquee-selection-plan.md`](superpowers/plans/2026-07-20-viewer-marquee-selection-plan.md) | Historical | — |
| [`superpowers/plans/2026-07-22-viewer-radial-contextmenu-fallback.md`](superpowers/plans/2026-07-22-viewer-radial-contextmenu-fallback.md) | Historical | — |
| [`superpowers/plans/2026-07-22-viewer-simplified-workspace-radial-menu-plan.md`](superpowers/plans/2026-07-22-viewer-simplified-workspace-radial-menu-plan.md) | Historical | — |
| [`superpowers/plans/2026-07-23-viewer-continuous-quality-governance-plan.md`](superpowers/plans/2026-07-23-viewer-continuous-quality-governance-plan.md) | Historical | — |
| [`superpowers/plans/2026-07-23-viewer-engineering-baseline-ci-plan.md`](superpowers/plans/2026-07-23-viewer-engineering-baseline-ci-plan.md) | Historical | — |
| [`superpowers/plans/2026-07-23-viewer-engineering-optimization-roadmap.md`](superpowers/plans/2026-07-23-viewer-engineering-optimization-roadmap.md) | Historical | — |
| [`superpowers/plans/2026-07-23-viewer-folder-filmstrip-rows.md`](superpowers/plans/2026-07-23-viewer-folder-filmstrip-rows.md) | Historical | — |
| [`superpowers/plans/2026-07-23-viewer-governance-m4-removal-plan.md`](superpowers/plans/2026-07-23-viewer-governance-m4-removal-plan.md) | Historical | — |
...
| Document | Status | Replaced by |
| --- | --- | --- |
| [`reviews/2026-07-16-g1-image-pipeline-review.md`](reviews/2026-07-16-g1-image-pipeline-review.md) | Historical | — |
| [`reviews/2026-07-16-g2-file-transactions-review.md`](reviews/2026-07-16-g2-file-transactions-review.md) | Historical | — |
| [`reviews/2026-07-16-g3-scan-search-review.md`](reviews/2026-07-16-g3-scan-search-review.md) | Historical | — |
| [`reviews/2026-07-16-g4-architecture-freeze-review.md`](reviews/2026-07-16-g4-architecture-freeze-review.md) | Historical | — |
...
- `Active` identifies a current source of truth.
- `Superseded` identifies a decision replaced by the document in the
  `Replaced by` column.
- `Historical` identifies point-in-time implementation or review evidence that
  remains useful for traceability but does not govern current development.
- Status is documentation governance only. It does not establish a development
