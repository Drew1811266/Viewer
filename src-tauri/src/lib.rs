...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::review::review_start_with_feedback,
            commands::review::review_resume,
            commands::review::review_add_feedback,
            commands::review::review_update_feedback,
            commands::review::review_update_feedback_text,
            commands::review::review_replace_feedback_anchor,
            commands::review::review_delete_feedback,
            commands::review::review_restore_deleted_feedback,
            ...
            commands::review_workspace::get_review_workspace,
            ...
            commands::video::video_request_cover,
