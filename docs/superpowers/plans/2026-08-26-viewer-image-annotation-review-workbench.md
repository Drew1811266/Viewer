...
- [ ] **Step 1: Write failing Domain tests for rectangle, stroke, and aggregate limits**
...
- [ ] **Step 2: Run the focused Domain tests and confirm the new types are missing**
...
- [ ] **Step 3: Implement immutable normalized geometry and rename the internal rectangle variant**
...
- [ ] **Step 4: Run the complete Domain review suite**
...
- [ ] **Step 1: Add byte-level characterization tests before moving code**
...
- [ ] **Step 2: Run the characterization tests before the split**
...
- [ ] **Step 3: Move v1 DTOs and codecs into focused modules**
...
- [ ] **Step 4: Run fixture, repository, and public-export regressions**
...
- [ ] **Step 1: Write failing codec and schema contract tests**
...
- [ ] **Step 2: Run the new contract tests and confirm v2 is unavailable**
...
- [ ] **Step 3: Implement the v2 stored Anchor union and versioned dispatch**
...
- [ ] **Step 4: Implement schemas with explicit limits and closed objects**
...
- [ ] **Step 5: Run Rust and schema contract suites**
...
- [ ] **Step 6: Commit the versioned protocol**
...
- [ ] **Step 1: Write failing Application contract tests for versioned records**
...
- [ ] **Step 2: Run the focused tests and verify the record types are missing**
...
- [ ] **Step 3: Define persistence-neutral record types and update the port**
...
- [ ] **Step 4: Write failing v1-index migration tests**
...
- [ ] **Step 5: Implement atomic v1-index migration and version-preserving draft I/O**
...
- [ ] **Step 6: Run catalog, protocol, and repository regressions**
...
- [ ] **Step 7: Commit versioned repository metadata**
...
- [ ] **Step 1: Write failure-injection tests for every durable boundary**
...
- [ ] **Step 2: Run repository tests and confirm bundle publication is absent**
...
- [ ] **Step 3: Define internal artifact and publication contracts**
...
- [ ] **Step 4: Implement the exact bundle transaction**
...
- [ ] **Step 5: Keep v1 publication on its existing byte path**
...
- [ ] **Step 6: Run bundle, repository, and protocol suites**
...
- [ ] **Step 7: Commit transactional bundle publication**
...
- [ ] **Step 1: Write failing renderer tests with deterministic pixel and bound assertions**
...
- [ ] **Step 2: Run the focused macOS tests and verify the renderer is missing**
...
- [ ] **Step 3: Expose a protected source path only inside Application**
...
- [ ] **Step 4: Enable only existing CoreGraphics modules and implement the renderer**
...
- [ ] **Step 5: Run renderer, image pipeline, and dependency policy tests**
...
- [ ] **Step 6: Commit the rendering adapter**
...
- [ ] **Step 1: Write failing tests for atomic first save**
...
- [ ] **Step 2: Write failing tests for fixed membership, anchor edits, v1 upgrade, and restore**
...
- [ ] **Step 3: Run the session tests and confirm the new commands fail to compile**
...
- [ ] **Step 4: Define the exact command and snapshot shapes**
...
- [ ] **Step 5: Implement start-with-feedback as a single persistence mutation**
...
- [ ] **Step 6: Implement version upgrades and server-held delete restore**
...
- [ ] **Step 7: Render artifacts only after final revalidation and before publish**
...
- [ ] **Step 8: Run all Application review tests**
...
- [ ] **Step 9: Commit the use-case layer**
...
- [ ] **Step 3: Run the bridge tests and verify missing shapes/commands**
...
- [ ] **Step 4: Implement strict DTOs and command registration**
...
- [ ] **Step 5: Mirror the exact discriminated union in TypeScript**
...
- [ ] **Step 6: Run DTO, command, adapter, and architecture boundary tests**
...
- [ ] **Step 1: Add characterization tests for ordinary preview behavior**
...
- [ ] **Step 2: Run the ordinary preview suite before extraction**
...
- [ ] **Step 3: Define the composable surface contract**
...
- [ ] **Step 4: Move viewport/rendering code and keep the wrapper thin**
...
- [ ] **Step 5: Add a static architecture test for the dependency direction**
...
- [ ] **Step 6: Run preview tests and production TypeScript build**
...
- [ ] **Step 7: Commit the preview seam**
...
- [ ] **Step 2: Write failing reducer tests for transient versus saved state**
...
- [ ] **Step 3: Run pure and hook tests and confirm the model is absent**
...
- [ ] **Step 4: Implement deterministic geometry functions**
...
- [ ] **Step 5: Implement an explicit editor reducer**
...
- [ ] **Step 6: Implement the workbench hook without optimistic persistence**
...
- [ ] **Step 7: Run model, coordinator, and API adapter tests**
...
- [ ] **Step 8: Commit the frontend state core**
...
- [ ] **Step 1: Write failing interaction tests for the primary four-issue flow**
...
- [ ] **Step 2: Write failing edit, selection, keyboard, and accessibility tests**
...
- [ ] **Step 3: Run component tests and confirm the workbench is missing**
...
- [ ] **Step 4: Implement the toolbar and stage overlay with existing assets**
...
- [ ] **Step 5: Implement inline editing and numbered feedback rail**
...
- [ ] **Step 6: Implement saved geometry editing rules**
...
- [ ] **Step 7: Run component, accessibility, and CSS policy tests**
...
- [ ] **Step 1: Write failing integration tests for preview selection and fixed scope**
...
- [ ] **Step 2: Write failing grid and leave-guard tests**
...
- [ ] **Step 3: Run integration tests and confirm the missing wiring**
...
- [ ] **Step 4: Add a narrow review presentation boundary to the workspace**
...
- [ ] **Step 5: Route preview states explicitly**
...
- [ ] **Step 6: Unify return and completion actions**
...
- [ ] **Step 7: Integrate leave guards and scope-exit choices**
...
- [ ] **Step 8: Run workspace, review, search, folder, and app tests**
...
- [ ] **Step 1: Write failing reader tests for mixed history**
...
- [ ] **Step 2: Run reader and manual-loop tests and confirm v2 fails**
...
- [ ] **Step 3: Implement safe version-aware resolution**
...
- [ ] **Step 4: Extend the manual harness with one four-annotation Round**
...
- [ ] **Step 5: Run the protocol and loop suites twice**
...
- [ ] **Step 6: Commit Agent interoperability**
...
- [ ] **Step 1: Add failing acceptance catalog and scene tests**
...
- [ ] **Step 2: Run acceptance unit tests and confirm the states are absent**
...
- [ ] **Step 3: Implement deterministic scenes and capture rules**

Reuse real workbench components and the acceptance bridge; seed stable IDs, image dimensions and four Chinese natural-language opinions. Update both `AcceptanceApp.tsx` and `viewer-visual-acceptance.mjs` so only RVW-15 and RVW-24 use zoom 2. Do not add screenshot-only substitute markup.

- [ ] **Step 4: Run functional, acceptance-unit, and production build gates**
...
- [ ] **Step 7: Run architecture, policy, documentation, and clean-tree verification**
