...
| `async-trait` | 0.1.99 | MIT OR Apache-2.0 | Async Application port traits and adapters | [dtolnay/async-trait](https://github.com/dtolnay/async-trait) | Yes, as expanded code |
...
| `bytemuck` | 1.25.1 | Zlib OR Apache-2.0 OR MIT | Checked conversion of renderer vertex and uniform data to GPU bytes | [Lokathor/bytemuck](https://github.com/Lokathor/bytemuck) | Yes |
...
| `objc2-core-video` | 0.3.2 | Zlib OR Apache-2.0 OR MIT | Drive native image frames from the active macOS display refresh signal | [madsmtm/objc2](https://github.com/madsmtm/objc2) | Yes |
...
| `wgpu` | 30.0.1 | MIT OR Apache-2.0 | Retained GPU rendering for image preview, annotations and magnifier composition | [gfx-rs/wgpu](https://github.com/gfx-rs/wgpu) | Yes |
