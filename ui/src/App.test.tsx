...
describe('Viewer empty state', () => {
  ...
  it('resizes the sidebar through pointer and keyboard separator input', async () => {
    ...
    expect(separator).toHaveAttribute('aria-valuenow', '152')
    ...
    expect(screen.getByLabelText('文件夹栏')).toHaveStyle({ width: '232px' })
    expect(separator).toHaveAttribute('aria-valuenow', '232')
    fireEvent.keyDown(separator, { key: 'ArrowLeft' })
    expect(screen.getByLabelText('文件夹栏')).toHaveStyle({ width: '216px' })
    ...
    fireEvent.keyDown(separator, { key: 'ArrowLeft' })
    expect(screen.getByLabelText('文件夹栏')).toHaveStyle({ width: '120px' })
  ...
  it('stops sidebar resize tracking when the pointer is cancelled', async () => {
    ...
    expect(sidebar).toHaveStyle({ width: '172px' })
    ...
    expect(widthAfterCancelledMove).toBe('172px')
  })
