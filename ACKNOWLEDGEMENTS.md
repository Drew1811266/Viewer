...
- [Rust](https://github.com/rust-lang/rust) and Cargo — native application language and build toolchain. The direct Rust crates in the foundation are `async-trait`, `futures`, `serde`, `tempfile`, `thiserror`, and `uuid`.
