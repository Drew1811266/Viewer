...
- [x] **Step 1: Write failing request and pixel-level rendering tests**
...
- [x] **Step 2: Run the macOS renderer tests and verify new anchors fail**
...
- [x] **Step 3: Add focused Core Graphics drawing helpers**
...
- [x] **Step 4: Run renderer and evidence integration tests**
...
- [x] **Step 5: Commit evidence rendering**
